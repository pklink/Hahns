...
$app->delete('/delete', function (\Hahns\Response\Json $response, \Hahns\Request $request) {
...
$app->delete('/hello/[.+:name]', function (\Hahns\Response\Json $response, \Hahns\Request $request) {
    return $response->send([
